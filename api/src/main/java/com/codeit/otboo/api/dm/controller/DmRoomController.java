...
import com.codeit.otboo.api.dm.service.DmRoomLeaveService;
...
public class DmRoomController {
    ...
    private final DmRoomLeaveService dmRoomLeaveService;
    ...
    public ResponseEntity<Void> leaveRoom(
        ...
        dmRoomLeaveService.leaveRoom(userDetails.getUserId(), roomId);
