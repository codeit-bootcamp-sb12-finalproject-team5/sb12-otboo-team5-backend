...
import com.codeit.otboo.api.weather.dto.KakaoRegionDto;
...
public class LocationService {
    ...
    private List<String> regionNames(KakaoRegionDto region) {
        return List.of(region.region1DepthName(), region.region2DepthName(),
                region.region3DepthName(), region.region4DepthName());
    }
